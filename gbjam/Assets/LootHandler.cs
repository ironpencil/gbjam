...
public class LootHandler : MonoBehaviour {
    ...
    private void DropLootItem(GameObject lootItem)
    {
        ...
        DelayInitialMovement delayMovement = lootItem.GetComponent<DelayInitialMovement>();
        ...
        TemporaryInvulnEffect invulnEffect = lootItem.GetComponent<TemporaryInvulnEffect>();
